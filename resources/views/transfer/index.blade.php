<x-app-layout>
    <title>Arewa Smart - Transfer to Smart User</title>
                            ...
                            <div class="col-xl-4 col-lg-6">
                                <div class="card shadow-lg border-0 rounded-4 h-100">
                                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center p-4" 
                                        ...
                                        <h5 class="mb-0 fw-bold"><i class="bi bi-send me-2"></i>Transfer Funds</h5>
    ...
    <script>
        function verifyUser() {
            ...
            if (!walletId) {
                userErrorDisplay.textContent = "Please enter a Wallet ID.";
        ...
        document.getElementById('confirmPinBtn').addEventListener('click', function() {
            ...
            .then(data => {
                if (data.valid) {
                    ...
                    confirmText.textContent = "Confirm Transfer";
