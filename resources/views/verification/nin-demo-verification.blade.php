<x-app-layout>
    <title>Smart Link - {{ $title ?? 'Demographic Verification' }}</title>
    <div class="page-body">
                            ...
                            @if (session('verification'))
                                ...
                                <div class="d-flex flex-wrap justify-content-center gap-2">
                                    ...
                                    <button onclick="confirmDownload('{{ route('premiumSlip', session('verification')['data']['nin']) }}', 'Premium Slip', {{ $premiumSlipPrice ?? 0 }})" 
                                     ...
                                     <button onclick="confirmDownload('{{ route('nin.demo.vninSlip', session('verification')['data']['nin']) }}', 'VNIN Slip', {{ $vninSlipPrice ?? 0 }})" 
