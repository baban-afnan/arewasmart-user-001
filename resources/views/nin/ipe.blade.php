                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="btn-group">
                                                        ...
                                                        <!-- View Comment -->
                                                        <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#responseModal" data-response="{{ $submission->comment ?? 'No comment yet.' }}">
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content border-0 shadow-lg rounded-3 overflow-hidden">
                        ...
                        <div class="modal-body p-4" style="font-size: 1rem; min-height: 180px;">
                            ...
                            <!-- Response Content -->
                            <pre id="responseContent" class="bg-white p-3 rounded border d-none" style="white-space: pre-wrap; font-size: 0.95rem;"></pre>
                        </div>
