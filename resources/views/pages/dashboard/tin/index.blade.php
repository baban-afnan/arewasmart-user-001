                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select" name="org_type" id="org_type" required>
                                                    ...
                                                    <option value="3" {{ old('org_type') == 'INCORPORATED TRUSTEE' ? 'selected' : '' }}>Incorporated Trustee</option>
                                                    <option value="4" {{ old('org_type') == 'LIMITED PARTNERSHIP' ? 'selected' : '' }}>Limited Partnership</option>
                                                    <option value="5" {{ old('org_type') == 'LIMITED LIABILITY PARTNERSHIP' ? 'selected' : '' }}>Limited Liability Partnership</option>
                                                </select>
                                            </div>
                                            <div class="col-md-12">
